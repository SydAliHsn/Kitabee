...
const page = (): JSX.Element => {
  ...
  return (
    <section>
      ...
      <div className="mx-auto mt-12 max-w-2xl rounded-lg bg-gray-50 p-4 pt-5 text-gray-800 shadow-md dark:bg-gray-900/70 dark:text-gray-200 dark:shadow-gray-800/40">
