    ...
    <>
      <section>
        <div className="flex flex-col items-center justify-center py-12">
          <h1 className="text-center text-3xl font-bold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">
            Exclusive Notes PDFs for Free!
          </h1>
          <p className="mt-6 max-w-4xl text-center text-lg leading-7 text-gray-600 dark:text-gray-400 sm:mt-8 sm:text-left sm:leading-8 xl:text-xl">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-8 sm:mt-10 sm:gap-10">
            <Link
              href="/upload"
